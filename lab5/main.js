...
function makeDrawing (canvas, choice1, x1, y1, choice2, x2, y2, showOrigin) {
    ...
    if (choice1 == "dog") {
        ...
        panda(item1, x1, y1, showOrigin, "normal");
    ...
    if (choice2 == "dog") {
        dog(item2, x2, y2, showOrigin, "wag_tail");
    } else if (choice2 == "ladybug") {
        ladybug(item2, x2, y2, showOrigin, "after");
    } else if (choice2 == "panda") {
        panda(item2, x2, y2, showOrigin, "mask");
    } else if (choice2 == "butterfly") {
        butterfly(item2, x2, y2, showOrigin);
    }
    
    // This function swaps the positions of the two drawings
